...
public class ItemController {
	...
	@GetMapping("/discount")
	public ResponseEntity<List<Item>> getDiscountedProducts(){
		List<Item> dicountitems=itemService.getDiscountedProducts();
		return new ResponseEntity<>(dicountitems,HttpStatus.OK);
	}
